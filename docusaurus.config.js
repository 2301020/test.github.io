    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {to: '/reflection', label: 'Reflection', position: 'left'},
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} OIP Group 23. Built with Docusaurus.`,
      },
      prism: {
